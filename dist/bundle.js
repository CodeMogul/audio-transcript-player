...
(function () {
	...
	*/
	 ...
	 * LICENSE file in the root directory of this source tree.
	 */
	{(function(){var React=react.exports;var _assign=objectAssign;var Scheduler=scheduler.exports;var tracing$1=tracing.exports;var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// by calls to these methods by a Babel plugin.
	//
	// In PROD (or in packages without access to React internals),
	// they are left as they are instead.
	...
	const AudioPlayerContext = /*#__PURE__*/React.createContext(null);
	function AudioPlayer({
	  ...
	  const seek = react.exports.useCallback(toTime => {
	    audioTrack.currentTime = parseFloat(toTime);
	    if (audioTrack.paused) play();
	  }, [play]);
	  const setPlaybackRate = react.exports.useCallback(rate => {
	  ...
	  return /*#__PURE__*/React.createElement(AudioPlayerContext.Provider, {
	    value: value
	  }, children);
	}
	...
	function useAudioPlayer() {
	  const context = react.exports.useContext(AudioPlayerContext);
	...
	var re = te("5.3.0"),
	    oe = function () {
	  function e(e, t, n) {
	    this.rules = e, this.staticRulesId = "", this.isStatic = "production" === "development"  , this.componentId = t, this.baseHash = ee(re, t), this.baseStyle = n, Z.registerId(t);
	  }
	...
	function Ne(e, n, r, o) {
	  ...
	  if (E(e)) {
	    ...
	    var u = e(n);
	    return reactIs$1.exports.isElement(u) && console.warn(b(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), Ne(u, n, r, o);
	  }
	  ...
	  return e instanceof ve ? r ? (e.inject(r, o), e.getName(o)) : e : g(e) ? function e(t, n) {
	    ...
	    for (var s in t) t.hasOwnProperty(s) && !be(t[s]) && (g(t[s]) ? i.push.apply(i, e(t[s], s)) : E(t[s]) ? i.push(Ee(s) + ":", t[s], ";") : i.push(Ee(s) + ": " + (r = s, null == (o = t[s]) || "boolean" == typeof o || "" === o ? "" : "number" != typeof o || 0 === o || r in unitlessKeys ? String(o).trim() : o + "px") + ";"));
	...
	var Ce = /invalid hook call/i,
	    ...
	    Ie = function (e, t) {
	  {
	    ...
	    try {
	      react.exports.useRef(), Ae.has(n) || (console.warn(n), Ae.add(n));
	    } catch (e) {
	...
	function Fe(e, t, n) {
	  ...
	  o && e.shouldForwardProp && (C = t.shouldForwardProp ? function (n, r, o) {
	    ...
	    return function (e, t, n, r) {
	      ...
	      var m = function (e, t, n) {
	        ...
	        return n.forEach(function (e) {
	          ...
	          for (t in E(s) && (s = s(r)), s) r[t] = o[t] = "className" === t ? (n = o[t], i = s[t], n && i ? n + " " + i : n || i) : s[t];
	        }), [r, o];
	      }(Pe(t, react.exports.useContext(Be), a) || w, t, o),
	          y = m[0],
	          g = m[1],
	          S = function (e, t, n, r) {
	        var o = pe(),
	            i = fe(),
	            s = t ? e.generateAndInjectStyles(w, o, i) : e.generateAndInjectStyles(n, o, i);
	        return react.exports.useDebugValue(s), !t && r && r(s), s;
	      }(s, r, y, e.warnTooManyClasses ),
	          b = n,
	      ...
	      for (var I in C) "$" !== I[0] && "as" !== I && ("forwardedAs" === I ? A.as = C[I] : (d ? d(I, index, N) : !_ || index(I)) && (A[I] = C[I]));

	      return t.style && g.style !== t.style && (A.style = v({}, t.style, {}, g.style)), A.className = Array.prototype.concat(c, h, S !== h ? S : null, t.className, g.className).filter(Boolean).join(" "), A.ref = b, /*#__PURE__*/react.exports.createElement(N, A);
	    }(A, e, t, P);
	  };

	  return O.displayName = y, (A = /*#__PURE__*/React.forwardRef(O)).attrs = _, A.componentStyle = I, A.displayName = y, A.shouldForwardProp = C, A.foldedComponentIds = o ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : S, A.styledComponentId = g, A.target = o ? e.target : e, A.withComponent = function (e) {
	    var r = t.componentId,
	        o = function (e, t) {
	      if (null == e) return {};
	      var n,
	  ...
	  }), (Ie(y, g), A.warnTooManyClasses = function (e, t) {
	    var n = {},
	        r = !1;
	    return function (o) {
	  ...
	  }, s && hoistNonReactStatics_cjs(A, e, {
	    attrs: !0,
	    componentStyle: !0,
	    displayName: !0,
	...
	var Ye = function (e) {
	  return function e(t, r, o) {
	    if (void 0 === o && (o = w), !reactIs$1.exports.isValidElementType(r)) return D(1, String(r));
	...
	function He(e) {
	  ...
	  function l(e) {
	    var t = pe(),
	        n = fe(),
	        o = react.exports.useContext(Be),
	        u = react.exports.useRef(t.allocateGSInstance(a)).current;
	    return React.Children.count(e.children) && console.warn("The global style component " + a + " was given child JSX. createGlobalStyle does not render children."), s.some(function (e) {
	      return "string" == typeof e && -1 !== e.indexOf("@import");
	    }) && console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."), d(u, e, t, o, n), null;
	  }
	  ...
	  return Ie(a), /*#__PURE__*/React.memo(l);
	}
	...
	const cleanWordTimings = paraTimings => {
	  return paraTimings.map(paraTiming => paraTiming.map(wordTiming => ({ ...wordTiming,
...
`;
	...
	function TranscriptPara({
	  ...
	  const paragraph = wordTimings.map((timing, index) => /*#__PURE__*/React.createElement("span", {
	    key: index,
	  ...
	  return /*#__PURE__*/React.createElement("article", {
	    className: currentTime ? 'active' : undefined
	  }, /*#__PURE__*/React.createElement("h5", null, startTimeHeading), /*#__PURE__*/React.createElement("p", null, paragraph));
	} // Memoizing Transcription Para to rerender only the one that is currently active


	const MemoisedTranscriptPara = /*#__PURE__*/React.memo(TranscriptPara);
	function Transcript({
	  paraTimings
	}) {
	  ...
	  const paragraphs = paraTimings.map((wordTimings, index) => {
	    const isActivePara = inRange(audioPlayer.currentTime, wordTimings[0].startTime, wordTimings[wordTimings.length - 1].endTime);
	    return /*#__PURE__*/React.createElement(MemoisedTranscriptPara, {
	      key: index,
	      wordTimings: wordTimings // NOTE: currentTime is passed only to activePara, thus avoiding re-renders of other paragraphs
	      ,
	      currentTime: isActivePara ? audioPlayer.currentTime : undefined
	    });
	  });
	  return /*#__PURE__*/React.createElement(TranscriptContainer, {
	    onClick: onClick
	  }, paragraphs);
	}
	...
	function LeftSeek() {
	  return /*#__PURE__*/React.createElement("svg", {
	    ...
	    d: "M0.999956 6.33334C1.17677 6.33334 1.34634 6.40358 1.47136 6.52861C1.59639 6.65363 1.66662 6.8232 1.66662 7.00001C1.65869 8.2487 2.08643 9.46107 2.87619 10.4283C3.66594 11.3956 4.76827 12.0571 5.99332 12.2991C7.21836 12.541 8.48944 12.3482 9.58762 11.7539C10.6858 11.1595 11.5424 10.2008 12.0097 9.04284C12.4771 7.8849 12.5261 6.60022 12.1482 5.41006C11.7703 4.2199 10.9892 3.19877 9.93949 2.52253C8.88974 1.84
	  }));
	}
	...
	function Pause() {
	  return /*#__PURE__*/React.createElement("svg", {
	    ...
	    d: "M4.90899 2.86365C4.53243 2.86365 4.22717 3.16891 4.22717 3.54547V14.4546C4.22717 14.8311 4.53243 15.1364 4.90899 15.1364H7.63626C8.01282 15.1364 8.31808 14.8311 8.31808 14.4546V3.54547C8.31808 3.16891 8.01282 2.86365 7.63626 2.86365H4.90899ZM5.59081 13.7727V4.22728H6.95445V13.7727H5.59081Z",
	    fill: "white"
	  }), /*#__PURE__*/React.createElement("path", {
	    d: "M10.3635 2.86365C9.98698 2.86365 9.68172 3.16891 9.68172 3.54547V14.4546C9.68172 14.8311 9.98698 15.1364 10.3635 15.1364H13.0908C13.4674 15.1364 13.7726 14.8311 13.7726 14.4546V3.54547C13.7726 3.16891 13.4674 2.86365 13.0908 2.86365H10.3635ZM11.0454 13.7727V4.22728H12.409V13.7727H11.0454Z",
	    fill: "white"
	  }));
	}
	...
	function Play() {
	  return /*#__PURE__*/React.createElement("svg", {
	    ...
	    d: "M1.17538 0.612144C1.33957 0.516531 1.53959 0.524173 1.69695 0.632071L8.85604 5.54116C9.0024 5.64153 9.09088 5.81439 9.09088 5.99999C9.09088 6.18558 9.0024 6.35845 8.85604 6.45881L1.69695 11.3679C1.53959 11.4758 1.33957 11.4834 1.17538 11.3878C1.0112 11.2922 0.909058 11.1086 0.909058 10.9091V1.0909C0.909058 0.891365 1.0112 0.707756 1.17538 0.612144ZM1.93178 2.08999V9.90999L7.63387 5.99999L1.93178 2.08999Z",
	    fill: "white"
	  }));
	}
...
`;
	function Controls() {
	  const audioPlayer = useAudioPlayer();
	  const onChangePlaybackRate = react.exports.useCallback(e => {
	    audioPlayer.setPlaybackRate(e.target.value);
	  }, []);
	  return /*#__PURE__*/React.createElement(StyledControlsContainer, null, /*#__PURE__*/React.createElement("button", {
	    onClick: () => audioPlayer.seek(audioPlayer.currentTime - 3)
	  }, /*#__PURE__*/React.createElement(LeftSeek, null)), /*#__PURE__*/React.createElement("button", {
	    key: audioPlayer.paused,
	    onClick: audioPlayer.paused ? audioPlayer.play : audioPlayer.pause,
	    className: "icon-button-lg"
	  }, audioPlayer.paused ? /*#__PURE__*/React.createElement(Play, null) : /*#__PURE__*/React.createElement(Pause, null)), /*#__PURE__*/React.createElement("button", {
	    onClick: () => audioPlayer.seek(audioPlayer.currentTime + 3)
	  }, /*#__PURE__*/React.createElement(RightSeek, null)), /*#__PURE__*/React.createElement("select", {
...
`;
	...
	function App() {
	  ...
	  }, /*#__PURE__*/React.createElement(Controls, null), /*#__PURE__*/React.createElement(Transcript, {
