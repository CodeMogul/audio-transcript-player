	...
	*/
	...
	function O$1(a, b, c, e, d) {
	  ...
	  if (Array.isArray(a)) for (var g = 0; g < a.length; g++) {
	    ...
	    var f = e + N$2(k, g);
	    h += O$1(k, b, c, f, d);
	  } else if (f = y$3(a), "function" === typeof f) for (a = f.call(a), g = 0; !(k = a.next()).done;) k = k.value, f = e + N$2(k, g++), h += O$1(k, b, c, f, d);else if ("object" === k) throw b = "" + a, Error(z$2(31, "[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b));
	  return h;
	}
	...
	function Ce(a, b, c) {
	  "focusin" === a ? (Ae(), pe$1 = b, qe$1 = c, pe$1.attachEvent("onpropertychange", Be$1)) : "focusout" === a && Ae();
	}
	...
	function Gi(a, b, c) {
	  ...
	  switch (b.tag) {
	    ...
	    case 19:
	      ...
	      return null !== d.tail ? (c = d.tail, d.rendering = c, d.tail = c.sibling, d.lastEffect = b.lastEffect, d.renderingStartTime = O(), c.sibling = null, b = P$1.current, I$1(P$1, f ? b & 1 | 2 : b & 1), c) : null;
	...
	var re = te("5.3.0"),
	    oe = function () {
	  function e(e, t, n) {
	    this.rules = e, this.staticRulesId = "", this.isStatic = (void 0 === n || n.isStatic) && ne(e), this.componentId = t, this.baseHash = ee(re, t), this.baseStyle = n, Z.registerId(t);
	  }
...
`;
	...
	const secondsToMinutesStr = seconds => {
...
`;
	...
	function TranscriptPara({
	  ...
	  }, /*#__PURE__*/React.createElement("h5", null, secondsToMinutesStr(wordTimings[0].startTime)), /*#__PURE__*/React.createElement("p", null, paragraph));
	...
	function TranscriptProgress({
	  ...
	  const {
	    ...
	    paraTimings.forEach((wordTimings, index) => {
	      if (index % 2) prospectParaTimings.push(wordTimings);else ourParaTimings.push(wordTimings);
	    });
	  ...
	  const seek = react.exports.useCallback(e => {
	  ...
	  return /*#__PURE__*/React.createElement(Container, null, /*#__PURE__*/React.createElement("span", {
	    className: "time"
	    ...
	    className: "progress",
	    style: {
	      width: (audioPlayer.currentTime / audioPlayer.duration * 100).toFixed(2) + '%'
	    }
	  }))));
	}
